...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] text-white relative overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 md:px-8 py-6 flex justify-between items-center backdrop-blur-md bg-[#0a0e1a]/80 border-b border-cyan-500/10">
